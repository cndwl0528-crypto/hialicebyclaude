...
function buildPrintDocument(innerHtml, bookTitle) {
  return `
    ...
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
        <title>HiMax Worksheet — ${bookTitle}</title>
        <style>
      ...
      */}
      <div ref={printRef} className="hidden" aria-hidden="true">
          ...
          return (
            <div key={stage} className="ws-stage">
              ...
              <div className="ws-stage-body">
                {/* HiMax's opening question for this stage */}
                {firstQuestion && (
                  <p className="ws-question">
                    HiMax asked: &ldquo;{firstQuestion}&rdquo;
                  </p>
                )}
        ...
        <div className="ws-footer">
          ...
          <p style={{ marginTop: '4px' }}>Generated by HiMax</p>
        </div>
